...
class RetinaFacenetwork(object):
    """
    RetinaFace network of fixed input size. Size can be defined only once when network is initialized.
    Size must be a multiplie of 32
    After network is initialized, all images provided as input must have the correct input size
    """
    ...
    def load_model(self):
        ...
        face_rpn_cls_score_reshape_stride32 = reshape_provided_shape(face_rpn_cls_score_stride32, (int(self.size/16),int(self.size/32),2),"face_rpn_cls_score_reshape_stride32")
        ...
        face_rpn_cls_prob_reshape_stride32 = reshape_provided_shape(face_rpn_cls_prob_stride32, (int(self.size/32), int(self.size/32), 4),"face_rpn_cls_prob_reshape_stride32")
        ...
        face_rpn_cls_score_reshape_stride16 = reshape_provided_shape(face_rpn_cls_score_stride16, (int(self.size/8), int(self.size/16), 2),"face_rpn_cls_score_reshape_stride16")
        ...
        face_rpn_cls_prob_reshape_stride16 = reshape_provided_shape(face_rpn_cls_prob_stride16, (int(self.size/16), int(self.size/16), 4),"face_rpn_cls_prob_reshape_stride16")
        ...
        face_rpn_cls_score_reshape_stride8 = reshape_provided_shape(face_rpn_cls_score_stride8, (int(self.size/4), int(self.size/8), 2),"face_rpn_cls_score_reshape_stride8")
        ...
        face_rpn_cls_prob_reshape_stride8 = reshape_provided_shape(face_rpn_cls_prob_stride8, (int(self.size/8), int(self.size/8), 4),"face_rpn_cls_prob_reshape_stride8")
